...
export default class PetPropProxy {
    public PropInfo(para: {
        onSuccess?: Function,
        thisObj?: any,
        onFail?: Function,
        data?
        ...
        HttpHelper.request({
            url: Config.linkURL + "/PetProp/PropInfo",
            data: para.data,
            method: "GET",
    ...
    public PropLogs(para: {
        ...
        HttpHelper.request({
            url: Config.linkURL + "/PetProp/PropLogs",
            data: para.data,
            method: "GET",
            success: function (data) {
                if (!data) {
    ...
    public PropBatchLogs(para: {
        ...
        HttpHelper.request({
            url: Config.linkURL + "/PetProp/PropBatchLogs",
            data: para.data,
            method: "GET",
            success: function (data) {
                if (!data) {
